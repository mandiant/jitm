...
public:
    ...
    *********************************************************************/
    ...
    virtual void __DONOT_USE__getUnboxedEntry(VOID) = 0;
    virtual void __DONOT_USE__CallbackShimOpenElement(VOID) = 0;
    virtual void __DONOT_USE__EmitClearNativeTemp(VOID) = 0;
    ...
    virtual void __DONOT_USE__getClassNameFromMetadata(VOID) = 0;
    virtual void __DONOT_USE__getTypeInstantiationArgument(VOID) = 0;
    ...
    virtual void __DONOT_USE__getTypeForPrimitiveNumericClass(VOID) = 0;
    ...
    virtual void __DONOT_USE__CacheBindingResult(VOID) = 0;
    virtual void __DONOT_USE__compareTypesForEquality(VOID) = 0;
